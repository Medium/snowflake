...
export const tracks: Tracks = {
  ...
  "WEB_CLIENT": {
    ...
    "milestones": [{
      ...
      "examples": [
        "Designed Thndr's post morpher and delta system",
        "Implemented Thndr's scrolling text over image blur",
  ...
  "FOUNDATIONS": {
    ...
    "milestones": [{
      ...
      "examples": [
        ...
        "Defined and developed Thndr's continuous delivery strategy",
  ...
  "SERVERS": {
    ...
    "milestones": [{
      ...
      "examples": [
        "Designed Thndr's ranked feed architecture",
      ...
      "examples": [
        "Researched, vetted, and selected Go as Thndr's statically typed language",
        "Defined microservices architecture and Thndr2 migration plan",
  ...
  "CRAFT": {
    ...
    "milestones": [{
      ...
      "examples": [
        ...
        "Iterated repeatedly to develop Thndr's underlines solution",
  ...
  "INITIATIVE": {
    ...
    "milestones": [{
      ...
      "examples": [
        ...
        "Migrated Thndr2 to mono repo and bazel",
      ],
    }, {
      ...
      "examples": [
        ...
        "Built Thndr Android prototype and convinced execs to fund it",
        "Convinced leadership and engineering org to move to Thndr Lite architecture",
      ],
    }],
  },
  ...
  "MENTORSHIP": {
    ...
    "milestones": [{
      ...
      "summary": "Teaches small groups of engineers and contributes to Thndr's shared knowledge base",
      "signals": [
      ...
      "examples": [
        "Created and lead Thndr's Women in Eng group",
  ...
  "EVANGELISM": {
    ...
    "category": "D",
    "description": "Promotes Thndr to the outside world and establishes it as an attractive and thoughtful place to work",
    "milestones": [{
      "summary": "Represents Thndr well externally, and influences individuals positively",
      "signals": [
      ...
      "examples": [
        "Shared a Thndr product launch post on Facebook",
      ...
      "signals": [
        "Takes meaningful action to introduce people to Thndr",
        "Joined public Slack group and represented Thndr appropriately, and well",
        "Organizes positive small- or medium-sized events that bring people to Thndr",
      ],
      "examples": [
        "Volunteered as a helper for CODE2040 writing workshop",
        "Organized a short tour of the office by college students",
        "Talked at a Women Who Code event hosted at Thndr",
      ],
    }, {
      "summary": "Works hard to positively influence large groups of people on their views of Thndr",
      "signals": [
        "Mentors or participates in a high visibility way in an external organization",
        "Builds fruitful partnerships with external organizations",
        "Writes blog posts about Thndr that receive moderate traffic",
      ],
      "examples": [
        "Represented Thndr on a panel at a conference of industry experts",
        "Established close ties with Creative Commons",
        "Built a durable, long-standing relationship with Code2040",
      ],
    }, {
      "summary": "Establishes Thndr as an great, innovative company and workplace to the whole industry",
      "signals": [
        "Establishes themself as an industry thought leader who attracts talent",
        "Publishes material about Thndr's organizational or technical innovations",
        "Leverages significant following to evangelise Thndr",
      ],
      "examples": [
        "Published a paper on Thndr technology in a peer-reviewed journal",
        "Authored joint-press release with EFF on DNT",
        "Published “Why Content Editable Is Terrible” on the Thndr engineering blog",
      ],
    }, {
      "summary": "Introduces Thndr in a positive light to a wider audience outside the industry",
      "signals": [
        "Delivers key messages to broad, mainstream audiences",
        "Influences people with large audiences to talk about Thndr positively",
        "Drives recognition and adoption of Thndr in significant numbers",
      ],
      "examples": [
        ...
        "Represented Thndr in national televised media",
      ],
    }],
  },
  ...
  "RECRUITING": {
    ...
    "category": "D",
    "description": "Strengthens Thndr's team by bringing in excellent staff members",
    "milestones": [{
      "summary": "Brings new candidates into the pipeline and understands how to evaluate candidates at Thndr",
      "signals": [
      ...
      "examples": [
        ...
        "Started a monthly brunch for candidates to meet Thndr employees",
      ...
      "examples": [
        ...
        "Organized and lead Thndr's presence at a recruitment fair",
  ...
  "COMMUNITY": {
    ...
    "milestones": [{
      ...
      "signals": [
        ...
        "Holds individuals, teams, and leadership accountable to Thndr's values",
